...
#	elif APIABSTRACTION_D3D9
	...
	pDevice->SetVertexShaderConstantF(162, (const float*)(&m_data), sizeof(m_data) / (4 * sizeof(float)));
	pDevice->SetPixelShaderConstantF(162, (const float*)(&m_data), sizeof(m_data) / (4 * sizeof(float)));
